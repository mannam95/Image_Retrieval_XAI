 ...
 */
package cifar_precision_recall;
 ...
 * @author SUBHAJIT
 */
public class Cifar_precision_recall {
    ...
    public static void loadData(HashMap<String, ArrayList<String>> fname_to_class_map, HashMap<String, ArrayList<String>> class_to_fname_map, String fname, ArrayList<String> cls) throws Exception {
        try {
            ...
            for (int i = 0; i < cls.size(); i++) {
                String ss = cls.get(i).toLowerCase();
                if (fname.contains(ss)) {
                    s = ss;
                    break;
                }
    ...
    public static void main(String[] args) throws Exception {
        ...
        ArrayList<String> _cls = new ArrayList<>();
        _cls.add("airplane");
        _cls.add("automobile");
        _cls.add("bird");
        _cls.add("cat");
        ...
        for (int i = 0; i < anots.size(); i++) {
            loadData(fname_to_class_map, class_to_fname_map, anots.get(i), _cls);
        }
